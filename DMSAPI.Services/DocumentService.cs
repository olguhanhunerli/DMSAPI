...
namespace DMSAPI.Services
{
	public class DocumentService : IDocumentService
	{
		...
		public async Task<DocumentCreateResponseDTO> CreateDocumentAsync(DocumentCreateDTO documentCreateDTO, int userIdFromToken)
		{
            ...
            return new DocumentCreateResponseDTO
            {
                Id = document.Id,
